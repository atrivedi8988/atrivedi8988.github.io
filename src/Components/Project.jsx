...
const data = [
    {
        ...
        techStack : "HTML | CSS | JS | ReactJS | ChakraUI | NPM Packages | Heroku API",
        feature : "Sign In, Sign Up, Product Page & Dynamic Cart Page, Single Page Website, Responsive for all devices",
        img : "IDEAKART.png",
    ...
    },
    {
        ...
        feature : "Sign up, Sign In, Sign Out, Navbar with Drop-down Menu, Products Page, Dynamic Individual Product Page, Dynamic Cart Page, Product Checkout page and Payment Page, Responsive for all devices",
        img : "NORDSTROM.png",
    ...
    },
    {
        ...
        techStack : "HTML | CSS | JS | Browser Local Storage",
        feature : "Sign up, Sign In, Sign Out, Navbar with Drop-down Menu, Products Page, Dynamic Individual Product Page, Dynamic Cart Page, Product Checkout page and Payment Page",
        img : "BathAndBody.png",
